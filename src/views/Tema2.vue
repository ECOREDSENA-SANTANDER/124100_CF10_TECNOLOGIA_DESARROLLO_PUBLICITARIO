...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.my-5(data-aos="zoom-in-left")
      .col-sm-12.col-lg-8
        span.title-card-3.bg15.mb-3.w-title-card-2 Escalas de color:
    ...
    SlyderF.align-items-center.mb-5(columnas="col-lg-6 col-xl-4")(data-aos="zoom-in-left")
      .tarjeta.color-secundario-cus.p-4
        ...
        p.text-center En #[i marketing ] y publicidad, por ejemplo, se utiliza como color de fondo para algunas marcas que pretenden transmitir felicidad, optimismo y positivismo.
